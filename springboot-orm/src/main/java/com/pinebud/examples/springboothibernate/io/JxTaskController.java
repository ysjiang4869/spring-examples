package com.pinebud.examples.springboothibernate.io;

import com.pinebud.examples.springboothibernate.service.JxAppService;
...
public class JxTaskController {
    ...
    public  JxTask addTasks(@RequestBody JxTask task){
